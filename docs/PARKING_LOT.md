...
- **Status update (2026-06-30)**: Slice 9 added the persisted `PlanHistoryEntry` foundation, Slice 10 uses it for existing Progress summaries, Slice 11 added archived-day details, Slice 12 added bounded previous-week and previous-month browsing with archive-only summaries, Slice 13 added ranked per-category stats, Slice 14 added current and longest completion streaks, and Slice 15 added gentle archive-derived text patterns for active days, categories, previous-period comparison, and weekday strength. **Still parked**: year/N-day views, custom range pickers, calendar-grid history, charts, and additional long-term analytics.
- **Why it is parked**: Day, week, and month list browsing with honest summaries and bounded text insights now exists. Calendar-grid history, arbitrary ranges, charts, and deeper analytics should wait for a concrete need and real archive-growth experience.
