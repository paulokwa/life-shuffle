...
- [ ] Add calendar ownership, member leave, delete, and feed-revocation basics (member self-leave done; owner delete/feed revocation on delete not done)
- [x] Add structured Settings area
- [x] Add Settings > Account: display name and sign out
- [ ] Add Settings > Calendar: name, switcher, create calendar, members, roles, leave, delete (name/switcher/create/owner/members/add member/member leave done; owner delete not done)
