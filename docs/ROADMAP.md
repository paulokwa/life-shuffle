...
- [ ] Add Settings > Calendar: name, switcher, create calendar, members, roles, leave, delete (name/switcher/create/owner/members/add member done; leave/delete not done)
